...
jQuery(function() {
  ...
  jQuery('#labelmapTab .eye').click(function() {
    jQuery('#labelmapTab .eye').toggleClass('show-icon').toggleClass('hide-icon');
  });
  jQuery('#mesh .eye').click(function() {
    jQuery('#mesh .eye').toggleClass('show-icon').toggleClass('hide-icon');
  });
  jQuery('#fibers .eye').click(function() {
    jQuery('#fibers .eye').toggleClass('show-icon').toggleClass('hide-icon');
  });
