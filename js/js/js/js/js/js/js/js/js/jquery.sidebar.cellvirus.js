...
*/
// CELLVIRUS panel javascript
jQuery(function() {
  
  jQuery('#cellvirusvisibility').click(function() {

    toggleMeshVisibility();
  });
  
  jQuery('#cellvirusColor').miniColors({
  ...
  jQuery("#opacity-cellvirus").slider({
    slide: opacityMesh
  });
  jQuery("#opacity-cellvirus").width(140);
